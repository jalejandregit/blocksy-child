...
add_action('save_post', 'topo_Custom_Excerpt', 50);
...
*/
	...
	remove_action('save_post', 'topo_Custom_Excerpt', 50); // Unhook this function so it doesn't loop infinitely

	wp_update_post( $post_array );

	add_action( 'save_post', 'topo_Custom_Excerpt', 50); // Re-hook this function
